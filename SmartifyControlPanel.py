...
root = ttk.Window(themename="darkly", scaling=1)
root.wm_title("Smartify ControlPanel")
...
def darkTheme():
  ...
  curTheme = 0
  style = ttk.Style()
  style.configure('my.TButton', font = ('Arial',20))
...
def loadProg():
  ...
  #folder = os.path.dirname(os.path.realpath(__file__))
  filetypes = (('robot program', '*.smartprog'),("all files", "*.*"))
...
def CreateProg():
  ...
  file_path = user_input + ".smartprog"
  with open(file_path,'w', encoding='utf-8') as f:
...
def insertCallProg():  
  ...
  if  str(changeProg[-4:]) != ".smartprog":
    changeProg = changeProg + ".smartprog"             
...
def savePosData():
  ...
  pickle.dump(value,open("SmartBot.cal","wb"))
...
speedLab = Label(tab1, text = "Speed",font=('Arial', 12))
speedLab.place(x=300, y=83)

ACCLab = Label(tab1, text = "Acceleration                %",font=('Arial', 12))
ACCLab.place(x=300, y=103)

DECLab = Label(tab1, text = "Deceleration               %",font=('Arial', 12) )
DECLab.place(x=300, y=123)

DECLab = Label(tab1, text = "Ramp                           %",font=('Arial', 12))
DECLab.place(x=300, y=143)

RoundLab = Label(tab1, text = "Rounding                   mm",font=('Arial', 12))
...
ifOnLab = Label(tab1,font=("Arial", 9), text = " Input      Tab")
ifOnLab.place(x=1107, y=350)

ifOffLab = Label(tab1,font=("Arial", 9), text = " Input      Tab")
ifOffLab.place(x=1107, y=390) 

regEqLab = Label(tab1,font=("Arial", 9), text = "Register     (++/--)")
regEqLab.place(x=1107, y=469)

ifregTabJmpLab = Label(tab1,font=("Arial", 9), text = "Register     Num      Tab")
ifregTabJmpLab.place(x=1107, y=509)

servoLab = Label(tab1,font=("Arial", 9), text = "Number   Position")
servoLab.place(x=1107, y=430)

storPosEqLab = Label(tab1,font=("Arial", 9), text = "Pos Reg   Element     (++/--)")
storPosEqLab.place(x=1107, y=549)

visPassLab = Label(tab1,font=("Arial", 9), text = "Pass Tab   Fail Tab")
visPassLab.place(x=1107, y=670)

ProgBut = Button(tab1,  text="Load", width=10,  command = loadProg, style='my.TButton')
...
try:
  Cal = pickle.load(open("SmartBot.cal","rb"))
except:
  Cal = "0"
  pickle.dump(Cal,open("SmartBot.cal","wb"))
for item in Cal:
